...
import {SELL_AS_COLORS, SELL_AS_MIX} from "@/constants/product.ts";
import Swatch from "./Swatch.tsx";
import {useAppDispatch, useAppSelector} from "@/app/hooks.ts";
import {selectProductCartItem, selectProductColorCode, selectSelectedProduct} from "@/ducks/products/selectors.ts";
import {setColorCode} from "@/ducks/products/actions.ts";
import type {ProductSwatchBase} from "chums-types/b2b";
import {isSellAsColors, isSellAsMix} from "@/ducks/products/utils.ts";
import Box from "@mui/material/Box";
import Typography from "@mui/material/Typography";
import {styled} from "@mui/material/styles";
import {ga4SelectColorItem} from "@/utils/ga4/generic.ts";
